...
const AssignmentPage = () => {
  ...
  useEffect(() => {
    ...
    // Also check if they submitted anything
            ...
            <div className="bg-white rounded-lg border border-[#E0E0E0] shadow-sm p-4">
                  ...
                  {files.map((f) => (
                    <div key={f.path} className="flex items-center gap-2.5 p-2.5 border border-[#DADCE0] rounded-lg bg-[#F8F9FA] group">
                      ...
                      <div className="flex-1 min-w-0">
                        <button onClick={() => handleDownload(f)} className="text-xs text-[#1967D2] font-medium truncate block hover:underline w-full text-left">
                          {f.name}
                        </button>
              ...
              {!submitted && (
                <div className="space-y-2 mb-4">
                  ...
                  {/* Open in Playground */}
                  <button onClick={() => navigate(`/coding-playground?assignmentId=${id}&classroomId=${classroomId}`)}

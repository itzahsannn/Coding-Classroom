...
export default function CodingPlaygroundPage() {
  ...
  // Load existing submission & validate assignment
  useEffect(() => {
    if (assignmentId) {
          ...
          <div className="flex items-center gap-2">
            ...
            {validAssignment && isStudent && (
              <button onClick={openSubmitModal}
                className="flex items-center gap-1.5 px-4 py-1.5 bg-[#6a1b9a] hover:bg-[#7b1fa2] text-white text-sm font-medium rounded-md transition-colors">
                ...
                {output !== null ? (
                  <>
                    <div className="mb-1">
                      ...
                      <span className="text-white"> {language.id === 'python' ? 'script.py' : 'main.js'}</span>
                    </div>

            ...
            <div key={teacher.id} className={`flex items-center justify-between py-4 ${index !== people.teachers.length - 1 ? 'border-b border-gray-100' : ''}`}>
              <div className="flex items-center gap-4 px-2">
                <div 
                  ...
                  style={{ 
                    backgroundColor: teacher.initial === 'T1' || teacher.initial === 'T4' ? '#F3F4F6' : '#F3E8FF',
                    color: teacher.initial === 'T1' || teacher.initial === 'T4' ? '#6B7280' : '#7E22CE' 
                  }}
                >
                  {teacher.initial}
                </div>
            ...
            <div key={student.id} className={`flex items-center justify-between py-4 ${index !== people.students.length - 1 ? 'border-b border-gray-100' : ''}`}>
              <div className="flex items-center gap-4 px-2">
                <div 
                  className="w-10 h-10 rounded-full flex items-center justify-center font-semibold shrink-0" 
                  style={{ 
                    backgroundColor: student.initial === 'S1' || student.initial === 'S4' || student.initial === 'S6' ? '#F3F4F6' : '#F3E8FF',
                    color: student.initial === 'S1' || student.initial === 'S4' || student.initial === 'S6' ? '#6B7280' : '#7E22CE' 
                  }}
                >
                  {student.initial}
                </div>
